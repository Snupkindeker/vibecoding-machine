...
When you need to perform an action, ALWAYS use the provided tool_calls mechanism,
do not output XML tags or plain text descriptions of tool usage.
Call the appropriate function from the tools list.
...
5. Here are the user's preferences for your responses and works:
    ...
    3) they do{" not" if not use_markdown else ""} want you to use markdown;
